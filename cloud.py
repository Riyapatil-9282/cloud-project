...
if analysis_choice == "Home":
    with header:
        ...
        st.markdown("<h1 style='text-align: center; color: yellow;'>Resham Patil</h1>", unsafe_allow_html=True)
        st.markdown("<h1 style='text-align: center; color: yellow;'>Riya Patil</h1>", unsafe_allow_html=True)
        st.markdown("<h1 style='text-align: center; color: yellow;'>Necia</h1>", unsafe_allow_html=True)
